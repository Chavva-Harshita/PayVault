...
import com.payvault.wallet.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAlreadyExists(WalletAlreadyExistsException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleFrozen(WalletFrozenException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, "WALLET_FROZEN", ex.getMessage(), request);
    }
